...
if (schemaMtime > clientMtime) {
	console.warn(
		'[prisma] Generated client is older than prisma/schema.prisma. Reusing committed client for local quality checks. Set PRISMA_FORCE_GENERATE=1 to refresh it.',
	);
} else {
