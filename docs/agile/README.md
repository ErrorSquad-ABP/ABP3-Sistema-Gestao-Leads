...
| Papel | Responsável |
| --- | --- |
| Product Owner | Leonardo da Silva Irineu |
| Tech Lead | Leonardo da Silva Irineu |
| Scrum Master | João Victor Lopes Rosa |
...
- `sprints.md` centraliza os períodos, estados e links detalhados de cada sprint;
