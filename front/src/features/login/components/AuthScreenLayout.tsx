	...
	return (
		<main className="relative min-h-screen bg-background">
			...
			<div className="grid min-h-screen lg:grid-cols-[34.5%_65.5%]">
				<section className="relative hidden min-h-screen overflow-hidden bg-foreground lg:flex">
					<video
						autoPlay
				...
				<section className="flex min-h-screen items-center justify-center border-l border-border bg-surface p-7 md:p-11">
					<div className="flex w-full max-w-102 flex-col items-center gap-4.5">
						<div className="flex w-full max-w-102 flex-col items-center gap-4.5 text-center">
							<div className="flex h-[2.85rem] w-[2.85rem] items-center justify-center rounded-full border border-[color:var(--brand-accent)]/20 bg-primary text-[1.16rem] font-semibold tracking-tight text-primary-foreground shadow-[0_0_0_4px_rgba(217,108,63,0.08)]">
								lc
							</div>
